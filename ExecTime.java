/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   3) Finally, we used a for loop to test QuickSort on
      ...
      *EXCEPTION* We only tested the arry with size 
      100,000 one hundred times because it exceeded the data
      limit bounds of an int.
   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
public class ExecTime {
	...
	tenTime /= 1000; 
	System.out.println("Time for sorting array of size 10: ");
	...
	System.out.println("Time for sorting array of size 1,000: ");
	System.out.println(thouTime);

	//timing how long it takes to QuickSort an array of size 100,000
	int hunthouTime = 0;
	...
	System.out.println("Time for sorting array of size 100,000: ");
